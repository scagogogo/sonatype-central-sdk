# URL
https://search.maven.org/solrsearch/select?q=a:guice&rows=20&wt=json

# Description
Search for any artifactId named "guice," irrespective of groupId. For each artifact returns details for the most recent version released.
